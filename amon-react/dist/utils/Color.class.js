...
class Color {
     ...
     * @returns {string}   : hex value
     */
    static rgb2Hex = (r, g, b, a = 1) => "#" + [r, g, b, a].map((x, i) => i === 3 ? a === 1 ? '' : parseInt((255 * x).toString()).toString(16)
    ...
    */
    ...
    static #interpolateColor = (color1, color2, factor = .5) => {
        const rgb1 = Object.values(Color.hex2RGB(color1)), rgb2 = Object.values(Color.hex2RGB(color2));
     ...
     */
    static #checkHexString = (str) => str.match(Color.#hexCheck) ? true : false;
}
